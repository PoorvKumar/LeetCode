...
// {
// private:
//     double champagneTowerUtil(int val,int i,int j)
//     {
//         if(i==0 && j==0)
//         {
//             return val;
...
//         if(j>0)
//         {
//             ans=ans+champagneTowerUtil(val,i-1,j-1)/(2*1.0);
//         }
        
//         if(j<i)
//         {
//             ans=ans+champagneTowerUtil(val,i-1,j)/(2*1.0);
//         }
...
//         int val=poured-((n*(n+1))/2);
        
//         cout<<n<<" "<<val<<endl;
        
//         return champagneTowerUtil(val,query_row,query_glass);
//     }
// };
